...
const showCorrespondingHeros = () => {
  ...
  function connection() {
    ...
    // INCASE OF LOAD END
        ...
        xhr.open("GET", `https://gateway.marvel.com/v1/public/characters?${params}&ts=1&apikey=db79500f1fd45db531923a694b6edc60&hash=a1a46ba5381a47f245d6419e89ad3429`, true);
  ...
  function comics(characterID) {
    ...
    // ON ERROR
      ...
      xhr.open("GET", `https://gateway.marvel.com/v1/public/characters/${id}/comics?&ts=1&apikey=db79500f1fd45db531923a694b6edc60&hash=a1a46ba5381a47f245d6419e89ad3429`, true);
